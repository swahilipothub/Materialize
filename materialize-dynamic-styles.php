...
$width_panel_1 = !empty($options['mn_width_panel_1']) ? $options['mn_width_panel_1'] : 250;
$width_panel_2 = !empty($options['mn_width_panel_2']) ? $options['mn_width_panel_2'] : 250;
$width_panel_3 = !empty($options['mn_width_panel_3']) ? $options['mn_width_panel_3'] : 250;
$width_panel_4 = !empty($options['mn_width_panel_4']) ? $options['mn_width_panel_4'] : 250;

if ($options['mn_sidebar_style'] == 'toolbar') $width_panel_1 = 100;
...
$color_panel_1 = $options['mn_color_panel_1'];
$color_panel_2 = $options['mn_color_panel_2'];
$color_panel_3 = $options['mn_color_panel_3'];
$color_panel_4 = $options['mn_color_panel_4'];
$bg_color_panel_1 = !empty($options['mn_bg_color_panel_1']) ? $options['mn_bg_color_panel_1'] : '#202b2d';
$bg_color_panel_2 = !empty($options['mn_bg_color_panel_2']) ? $options['mn_bg_color_panel_2'] : '#b5b5b5';
$bg_color_panel_3 = !empty($options['mn_bg_color_panel_3']) ? $options['mn_bg_color_panel_3'] : '#36939e';
$bg_color_panel_4 = !empty($options['mn_bg_color_panel_4']) ? $options['mn_bg_color_panel_4'] : '#9e466b';

$icon_color = !empty($options['mn_icon_color']) ? $options['mn_icon_color'] : '#777';

$font = $options['mn_font'];
$font_c = $options['mn_c_font'];
$weight = $options['mn_font_weight'];
$opacityLevel = $options['mn_fade_content'] === 'light' ? 0.6 : ($options['mn_fade_content'] === 'dark' ? 0.9 : 0);
...
$line = $options['mn_label_width'];
$transform = $options['mn_uppercase'] === 'yes' ? 'uppercase' : 'capitalize';
$searchbg = $options['mn_search_bg'] === 'light' ? 'rgba(255, 255, 255, 0.05)' : 'rgba(0, 0, 0, 0.3)';
?>
<script>
    ...
    (function(){
        var mob_bar = '<?php echo $options['mn_mob_nav'] === 'yes'?>';
        var pos = '<?php echo $options['mn_sidebar_pos']?>';
        var iconbar = '<?php echo $options['mn_sidebar_style'] == 'toolbar'; ?>';
...
<style id="materialize-dynamic-styles">
...
<?php if(isset($options['mn_bg_color_panel_1'])): ?>
#sfm-sidebar .sfm-sidebar-bg, #sfm-sidebar .sfm-social {
	background-color: <?php echo $options['mn_bg_color_panel_1']; ?> !important;
}
<?php endif; ?>

<?php if(isset($options['mn_transparent_panel']) && $options['mn_transparent_panel'] != 'none'): ?>
#sfm-sidebar .sfm-sidebar-bg  {
	background-color: <?php echo $options['mn_transparent_panel'] == 'dark' ? 'rgba(0,0,0,0.7)' : 'rgba(255,255,255, 0.7)'; ?> !important;
}
...
<?php if(intval($options['mn_font_size']) > 25): ?>
...
<?php
$shift = ((int) $options['mn_icon_size']) + 28 + 12;
?>
...
#sfm-sidebar .sfm-social {
    ...
    <?php if(!empty($options['mn_image_bg'])): ?>
    .sfm-sidebar-bg {
        background-image: url(<?php echo $options['mn_image_bg'] ; ?>);
    ...
    <?php endif; ?>
<?php if($options['mn_highlight'] == 'semi-dark'): ?>
    #sfm-sidebar .sfm-menu li > a:before {
    background: rgba(0, 0, 0, 0.05) !important;
}
    <?php endif; ?>

<?php if($options['mn_highlight'] == 'solid'): ?>
...
<?php if($options['mn_highlight'] == 'line'): ?>
...
<?php endif; ?>
<?php if ($options['mn_alignment'] != 'center'): ?>
#sfm-sidebar .sfm-menu li a,
#sfm-sidebar .sfm-chapter,
#sfm-sidebar .widget-area,
.sfm-search-form input {
	padding-<?php echo $options['mn_alignment']; ?>: 28px !important;
}

#sfm-sidebar.sfm-compact  .sfm-social li {
	text-align: <?php echo $options['mn_alignment']; ?>;
}

#sfm-sidebar.sfm-compact  .sfm-social:before {
	right: auto;
	left: auto;
<?php echo $options['mn_alignment']; ?>: 10%;
}
...
<?php if ($options['mn_search'] == 'hidden'): ?>
#sfm-sidebar .search-form {
	display: none !important;
}
<?php endif; ?>

<?php if($options['mn_sidebar_behaviour'] == 'push' && ($options['mn_sidebar_style'] == 'side' || $options['mn_sidebar_style'] == 'skew')): ?>
...
<?php if($options['mn_sidebar_behaviour'] == 'always'): ?>
...
<?php if($options['mn_sidebar_style'] == 'full'): ?>
#sfm-sidebar {
	/*z-index: 1;*/
}
...
.sfm-body-pushed #sfm-overlay, body[class*="sfm-view-pushed"] #sfm-overlay {
    opacity: 1 !important;
    background: <?php echo $options['mn_fade_full']?> !important;
}
...
#sfm-sidebar .sfm-menu a img{
	max-width: <?php echo $options['mn_icon_size']; ?>px;
	max-height: <?php echo $options['mn_icon_size']; ?>px;
}
#sfm-sidebar .sfm-menu .fa{
	font-size: <?php echo $options['mn_icon_size']; ?>px;
	min-width: <?php echo $options['mn_icon_size']; ?>px;
	min-height: <?php echo $options['mn_icon_size']; ?>px;
}

<?php if($options['mn_highlight_active'] == 'yes'): ?>
...
#sfm-sidebar .sfm-menu li a, #sfm-sidebar .sfm-chapter, #sfm-sidebar .sfm-search-form {
	padding: <?php echo $options['mn_padding']; ?>px 0;
	text-transform: <?php echo $transform; ?>;
}

#sfm-sidebar .sfm-search-form span {
	top: <?php echo intval($options['mn_padding']) + (intval($options['mn_font_size']) - 16) / 2 + 2; ?>px;
}
...
#sfm-sidebar .sfm-sm-indicator {
	line-height: <?php echo $options['mn_font_size'];?>px;
}

#sfm-sidebar .sfm-search-form input {
	font-size: <?php echo $options['mn_font_size']; ?>px;
}
...
#sfm-sidebar .sfm-menu .sfm-chapter {
	font-size: <?php echo $options['mn_c_fs']; ?>px;
	margin-top: <?php echo $options['mn_padding']; ?>px;
}
...
#sfm-sidebar .sfm-menu-level-0 li .sfm-sm-indicator i,#sfm-sidebar .sfm-menu-level-0 .sfm-sl, .sfm-title h2, .sfm-social:after {
	color: <?php echo $options['mn_scolor_panel_1']; ?>;
}#sfm-sidebar .sfm-menu-level-1 li .sfm-sm-indicator i,#sfm-sidebar .sfm-menu-level-1 .sfm-sl {
	 color: <?php echo $options['mn_scolor_panel_2']; ?>;
 }#sfm-sidebar .sfm-menu-level-2 li .sfm-sm-indicator i,#sfm-sidebar .sfm-menu-level-2 .sfm-sl {
	  color: <?php echo $options['mn_scolor_panel_3']; ?>;
  }#sfm-sidebar .sfm-menu-level-3 li .sfm-sm-indicator i,#sfm-sidebar .sfm-menu-level-3 .sfm-sl {
	   color: <?php echo $options['mn_scolor_panel_4']; ?>;
   }
    .sfm-menu-level-0 .sfm-chapter {
        color: <?php echo $options['mn_chapter_1']; ?> !important;
    }    .sfm-menu-level-1 .sfm-chapter {
        color: <?php echo $options['mn_chapter_2']; ?> !important;
    }    .sfm-menu-level-2 .sfm-chapter {
        color: <?php echo $options['mn_chapter_3']; ?> !important;
    }    .sfm-menu-level-3 .sfm-chapter {
        color: <?php echo $options['mn_chapter_4']; ?> !important;
    }
...
.sfm-navicon-button {
	top: <?php echo $options['mn_label_top'] ?>;
}

.sfm-mobile .sfm-navicon-button {
	top: <?php echo $options['mn_label_top_mobile'] ?>;
}

	<?php if($options['mn_sidebar_pos'] == 'left'): ?>
.sfm-navicon-button {
	left: <?php echo $options['mn_label_shift'] ?> !important;;
}
.sfm-mobile .sfm-navicon-button {
	left: inherit;
}
...
<?php if($options['mn_sidebar_pos'] == 'right'): ?>
.sfm-navicon-button {
	right: <?php echo $options['mn_label_shift'] ?> !important;
}
.sfm-mobile .sfm-navicon-button {
	right: inherit;
}
...
.sfm-label-none .sfm-navicon:after {
	top: -<?php echo $options['mn_label_gaps'] ?>px;
}
.sfm-navicon:before,
...
<?php if($options['mn_label_text'] == 'yes'): ?>

.sfm-navicon-button:after {
	display: block;
	content: "<?php echo esc_html($options['mn_label_text_field']); ?>";
	line-height: 18px;
	font-size: 12px;
	font-weight: <?php echo $weight; ?>;
	text-align: center;
    ...
    width: 200%;
    margin: 5px 0 0 0;
	color: <?php echo $options['mn_label_text_color']; ?>;
}
...
<?php if($options['mn_separators'] == 'yes'): ?>

#sfm-sidebar .sfm-menu li:after {
	content: '';
	display: block;
	width: <?php echo $options['mn_separators_width'] ?>%;
	...
	right: 0;
	height: 1px;
	background: <?php echo $options['mn_separators_color']; ?>;
	margin: 0 auto;
}
...
.sfm-style-skew #sfm-sidebar .sfm-menu-level-0 li a:hover{
	color: <?php echo $options['mn_chapter_1']; ?>;
}
...
#sfm-mob-navbar {
	background-color: <?php echo $options['mn_label_color']; ?>;
}
...
#sfm-mob-navbar .sfm-navicon:before  {
	background-color: <?php echo $options['mn_label_icon_color']; ?>;
}
.sfm-navicon-button .mn_label_icon{
	color: <?php echo $options['mn_label_icon_color']; ?>;
}

.sfm-label-square .sfm-navicon-button,
.sfm-label-rsquare .sfm-navicon-button,
.sfm-label-circle .sfm-navicon-button {
	color: <?php echo $options['mn_label_color']; ?>;
}

.sfm-navicon-button .mn_label_icon{
	width: <?php echo $options['mn_label_size']; ?>;
	height: <?php echo $options['mn_label_size']; ?>;
	font-size: calc(<?php echo $options['mn_label_size']; ?> * .6);
}
.sfm-navicon-button .mn_label_icon.la_icon_manager_custom{
	width: <?php echo $options['mn_label_size']; ?>;
	height: <?php echo $options['mn_label_size']; ?>;
}
.sfm-navicon-button.mn_label_default{
	width: <?php echo $options['mn_label_size']; ?>;
	height: <?php echo $options['mn_label_size']; ?>;
}

#sfm-sidebar [class*="sfm-icon-"] {
	color: <?php echo $options['mn_social_color']; ?>;
}

#sfm-sidebar .sfm-social li {
	border-color: <?php echo $options['mn_social_color']; ?>;
}
...
<?php if( $options['mn_mob_nav'] === 'yes' ): ?>
	@media screen and (max-width: <?php echo $options['mn_threshold_point'];?>px) {
		#sfm-mob-navbar  {
			display: none;
			height: 62px;
			width: 100%;
	...
	<?php endif; ?>
<?php if(isset($options['mn_css'])): ?>
<?php echo $options['mn_css']; ?>
<?php endif; ?>
</style>


<?php if($options['mn_transition'] == 'yes'): ?>
	<style>
		body {
			display: none;
		}</style>
...
<script>
    ...
    (function (){
        ...
        var timer, _timer;
        var transition = '<?php echo $options['mn_transition'] == 'yes'; ?>';
